...
public class Pinball_game extends JPanel 
{
	
	private static final long serialVersionUID = 1L;
	Timer t = new Timer(1, new Listener());
	int ctr = 0;
	double G = 0.1; //This is a Gravitational Constant
	final int xpos = 280;	
	double[] p2d = {280, 200};
	double[] v2d = {0, 0};
	int points = 0;
	...
	public void paintComponent(Graphics g){
		...
		if(setlock == false){
			sv *= 0.85; //  the dampening coefficient for the (springiness)
			sv -= (sd - snorm)/30;
			sd += sv;
		}
		double rc = 0.1;
